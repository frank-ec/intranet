...
<?php include('includes/header.php') ?>
			<nav>
				<div id="popup">
				<ul class="nav">
					<li><a href="https://www.gestiondocumental.gob.ec" target="_blank"><img align="center" border="3" height="50" width="80" src="img/quipux.jpg"><span>Quipux</span></a></li>
					<li><a href="https://agendamiento.msp.gob.ec/" target="_blank"><img align="center" border="3" height="50" width="80" src="img/sau.png"><span>Agendamiento - SAU</span></a></li>
...
<li><a href="matrices.php" ><img align="center" border="3" height="50" width="80" src="./img/matrices.jpeg"><span>Formularios en Línea</span></a></li>
		...
		<ul>
					...
					if ($uo == 'Hospital Básico Cayambe') {
                        echo '<li><img src="./img/centralhbc.png"></li>';
                                }
